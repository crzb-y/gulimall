<template>
  <el-dialog
    ...
    <el-form-item label="值类型【0-单个值，1-可选多个值】" prop="valueType">
      <el-input v-model="dataForm.valueType" placeholder="值类型【0-单个值，1-可选多个值】"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          valueType: [
            { required: true, message: '值类型【0-单个值，1-可选多个值】不能为空', trigger: 'blur' }
          ]
        }
      }
    },
